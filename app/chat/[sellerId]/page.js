      ...
      <div className="flex items-center justify-between p-4 bg-gray-800 border-b border-gray-700">
        <Link href="/">
          <div className="flex items-center space-x-2 cursor-pointer">
            ...
            <div>
              <h1 className="text-lg font-medium text-gray-100">Chat with {seller.name}</h1>
        ...
        <button
          ...
          className="px-4 py-2 text-sm font-medium rounded-full bg-gray-700 hover:bg-gray-600 text-gray-200 transition-all duration-200 flex items-center space-x-1"
        >
      ...
      >
            ...
            >
              ...
              <div className={`mt-2 text-xs flex items-center ${msg.sender === "user" ? "text-blue-200" : "text-gray-400"}`}>
                {msg.sender === "user" ? (
                  ...
                  <>
                    <div className="w-5 h-5 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white text-xs mr-1.5">{seller.name.charAt(0)}</div>
        ...
        {isTyping && (
          <div className="flex items-center space-x-2 text-gray-400">
            <div className="w-7 h-7 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white text-xs">{seller.name.charAt(0)}</div>
